...
grep -q "not the framework repo's own" AGENTS.md
grep -q "operating guide" AGENTS.md
grep -q "startup guide for" AGENTS.md
grep -q "apps generated by" AGENTS.md
grep -q "Generated app .*AGENTS.md.* should point to that route" AGENTS.md
grep -q "https://carbide.ryangerardwilson.com/for/agents" AGENTS.md
grep -q "docs/engineering/PRODUCT_CONTRACT.md" AGENTS.md
grep -q "docs/site/for/agents.md" AGENTS.md
