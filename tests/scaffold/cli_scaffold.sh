...
grep -q "README.md" "$tmp_dir/demo/AGENTS.md"
grep -q "carbide run dev" "$tmp_dir/demo/AGENTS.md"
grep -q "carbide health" "$tmp_dir/demo/AGENTS.md"
grep -q "carbide status" "$tmp_dir/demo/AGENTS.md"
grep -q "## Product Truth" "$tmp_dir/demo/README.md"
grep -q "## Users And Roles" "$tmp_dir/demo/README.md"
grep -q "## Business Rules" "$tmp_dir/demo/README.md"
grep -q "## Acceptance Criteria" "$tmp_dir/demo/README.md"
grep -q "## Laws And Audits" "$tmp_dir/demo/README.md"
! grep -q "curl -fsSL" "$tmp_dir/demo/README.md"
! grep -q "carbide new" "$tmp_dir/demo/README.md"
...
grep -Eq "^agents[[:space:]]+ok[[:space:]]+AGENTS.md /for/agents" "$tmp_dir/health.out"
