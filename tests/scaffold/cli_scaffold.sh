...
grep -q "^  doctor runtime " "$tmp_dir/help.out"
...
test -f "$tmp_dir/demo/agents.d/BACKUP_RESTORE.md"
test -f "$tmp_dir/demo/agents.d/DEPLOY.md"
test -f "$tmp_dir/demo/agents.d/ENVIRONMENT.md"
test -f "$tmp_dir/demo/agents.d/TAILWIND_COMPONENTS.md"
...
test -f "$tmp_dir/demo/web/src/main.jsx"
test -f "$tmp_dir/demo/web/src/server.jsx"
test -f "$tmp_dir/demo/web/src/write-index.mjs"
test -f "$tmp_dir/demo/web/src/styles.css"
test -f "$tmp_dir/demo/web/src/lib/cx.js"
test -d "$tmp_dir/demo/web/src/component/l1"
test -d "$tmp_dir/demo/web/src/component/l2"
test -d "$tmp_dir/demo/web/src/component/l3"
test -f "$tmp_dir/demo/web/src/component/l1/Button.jsx"
test -f "$tmp_dir/demo/web/src/component/l1/Field.jsx"
test -f "$tmp_dir/demo/web/src/component/l1/Surface.jsx"
test -f "$tmp_dir/demo/web/src/component/l1/Text.jsx"
test -f "$tmp_dir/demo/web/src/component/l1/ThemeToggle.jsx"
test -f "$tmp_dir/demo/web/src/component/l1/index.js"
test -f "$tmp_dir/demo/web/src/component/l1/tokens.js"
test -f "$tmp_dir/demo/web/src/component/l2/AuthForm.jsx"
test -f "$tmp_dir/demo/web/src/component/l2/Layouts.jsx"
test -f "$tmp_dir/demo/web/src/component/l2/index.js"
test -f "$tmp_dir/demo/web/src/component/l3/AuthView.jsx"
test -f "$tmp_dir/demo/web/src/component/l3/DashboardView.jsx"
test -f "$tmp_dir/demo/web/src/component/l3/LoadingView.jsx"
test -f "$tmp_dir/demo/web/src/component/l3/index.js"
...
grep -q "Demo Agent Context" "$tmp_dir/demo/AGENTS.md"
grep -q 'agents.d/ENVIRONMENT.md' "$tmp_dir/demo/AGENTS.md"
grep -q 'agents.d/DEPLOY.md' "$tmp_dir/demo/AGENTS.md"
grep -q 'agents.d/BACKUP_RESTORE.md' "$tmp_dir/demo/AGENTS.md"
grep -q 'agents.d/TAILWIND_COMPONENTS.md' "$tmp_dir/demo/AGENTS.md"
grep -q "separate secrets container" "$tmp_dir/demo/agents.d/ENVIRONMENT.md"
grep -q "preview-before-apply" "$tmp_dir/demo/agents.d/DEPLOY.md"
grep -q "Postgres owns durable application state" "$tmp_dir/demo/agents.d/BACKUP_RESTORE.md"
grep -q "Tailwind Component Organization" "$tmp_dir/demo/agents.d/TAILWIND_COMPONENTS.md"
grep -q "Use L1/L2/L3 in two related ways" "$tmp_dir/demo/agents.d/TAILWIND_COMPONENTS.md"
grep -q "component/l1/" "$tmp_dir/demo/agents.d/TAILWIND_COMPONENTS.md"
grep -q "component/l2/" "$tmp_dir/demo/agents.d/TAILWIND_COMPONENTS.md"
grep -q "component/l3/" "$tmp_dir/demo/agents.d/TAILWIND_COMPONENTS.md"
grep -q "web/src/lib/cx.js" "$tmp_dir/demo/agents.d/TAILWIND_COMPONENTS.md"
grep -q "visible focus styling" "$tmp_dir/demo/agents.d/TAILWIND_COMPONENTS.md"
grep -q "Do not add a parallel .*theme.css" "$tmp_dir/demo/agents.d/TAILWIND_COMPONENTS.md"
...
grep -q "Bun.serve" "$tmp_dir/demo/web/src/server.jsx"
grep -q "browser entrypoint" "$tmp_dir/demo/web/src/server.jsx"
grep -q "listening inside container" "$tmp_dir/demo/web/src/server.jsx"
grep -q "proxying /api and /health to api service" "$tmp_dir/demo/web/src/server.jsx"
grep -q "publicRoot" "$tmp_dir/demo/web/src/server.jsx"
grep -q "Cache-Control" "$tmp_dir/demo/web/src/server.jsx"
grep -q "public, max-age=31536000, immutable" "$tmp_dir/demo/web/src/server.jsx"
grep -q "return 'no-store'" "$tmp_dir/demo/web/src/server.jsx"
...
grep -q "asset-manifest.json" "$tmp_dir/demo/web/src/write-index.mjs"
grep -F -q '/assets/${scripts[0]}' "$tmp_dir/demo/web/src/write-index.mjs"
! grep -q "Bun frontend listening on http://localhost" "$tmp_dir/demo/web/src/server.jsx"
grep -q '@import "tailwindcss";' "$tmp_dir/demo/web/src/styles.css"
grep -q "@theme" "$tmp_dir/demo/web/src/styles.css"
grep -q -- "--color-carbide-action" "$tmp_dir/demo/web/src/styles.css"
grep -q "\\[data-theme=\"dark\"\\]" "$tmp_dir/demo/web/src/styles.css"
grep -q "color-scheme: dark" "$tmp_dir/demo/web/src/styles.css"
grep -q "font-size: 14px" "$tmp_dir/demo/web/src/styles.css"
grep -q "line-height: 1.4" "$tmp_dir/demo/web/src/styles.css"
grep -q "var(--carbide-page)" "$tmp_dir/demo/web/src/styles.css"
grep -q -- "--carbide-page: #ffffff" "$tmp_dir/demo/web/src/styles.css"
grep -q -- "--carbide-page: #000000" "$tmp_dir/demo/web/src/styles.css"
grep -q "bg-carbide-hero text-carbide-hero-text" "$tmp_dir/demo/web/src/component/l1/tokens.js"
! grep -Eq "#0f766e|#115e59|#2dd4bf|#5eead4|#16433c|#0f302c|#16211b|#edf5ef|#ecfdf5|#166534" "$tmp_dir/demo/web/src/styles.css"
! grep -q "from-carbide-action via-carbide-hero-via" "$tmp_dir/demo/web/src/component/l1/tokens.js"
! grep -q "theme.css" "$tmp_dir/demo/web/src/styles.css"
grep -F -q "text-2xl/8 sm:text-3xl/9" "$tmp_dir/demo/web/src/component/l1/Text.jsx"
grep -F -q "min-h-8 rounded-md border px-2 py-1 text-sm/6" "$tmp_dir/demo/web/src/component/l1/Field.jsx"
grep -F -q "md: 'min-h-8 px-3 text-xs'" "$tmp_dir/demo/web/src/component/l1/Button.jsx"
grep -F -q "gap-3 border-l px-4 py-5" "$tmp_dir/demo/web/src/component/l2/AuthForm.jsx"
grep -F -q "w-full max-w-sm justify-self-center gap-3" "$tmp_dir/demo/web/src/component/l2/AuthForm.jsx"
grep -F -q "lg:grid-cols-[216px_minmax(0,1fr)]" "$tmp_dir/demo/web/src/component/l2/Layouts.jsx"
grep -F -q "px-3 py-4 sm:px-5 lg:py-5" "$tmp_dir/demo/web/src/component/l2/Layouts.jsx"
...
grep -q '/api/${mode}' "$tmp_dir/demo/web/src/main.jsx"
grep -q "carbide.theme" "$tmp_dir/demo/web/src/main.jsx"
grep -q "useThemeMode" "$tmp_dir/demo/web/src/main.jsx"
grep -q "prefers-color-scheme: dark" "$tmp_dir/demo/web/index.html"
grep -q "dataset.theme" "$tmp_dir/demo/web/index.html"
grep -q "ThemeToggle" "$tmp_dir/demo/web/src/component/l1/ThemeToggle.jsx"
grep -q "data-resolved-theme" "$tmp_dir/demo/web/src/component/l1/ThemeToggle.jsx"
grep -q "data-theme-mode" "$tmp_dir/demo/web/src/component/l1/ThemeToggle.jsx"
grep -q "SunIcon" "$tmp_dir/demo/web/src/component/l1/ThemeToggle.jsx"
grep -q "MoonIcon" "$tmp_dir/demo/web/src/component/l1/ThemeToggle.jsx"
grep -q "Switch to light theme" "$tmp_dir/demo/web/src/component/l1/ThemeToggle.jsx"
grep -q "Switch to dark theme" "$tmp_dir/demo/web/src/component/l1/ThemeToggle.jsx"
grep -q "size-8 rounded-full border" "$tmp_dir/demo/web/src/component/l1/ThemeToggle.jsx"
grep -q "onClick={() => onMode?.(nextMode)}" "$tmp_dir/demo/web/src/component/l1/ThemeToggle.jsx"
! grep -q "<select" "$tmp_dir/demo/web/src/component/l1/ThemeToggle.jsx"
! grep -q "appearance-none" "$tmp_dir/demo/web/src/component/l1/ThemeToggle.jsx"
! grep -q "border-x-4 border-t-4 border-x-transparent" "$tmp_dir/demo/web/src/component/l1/ThemeToggle.jsx"
! grep -q "aria-pressed" "$tmp_dir/demo/web/src/component/l1/ThemeToggle.jsx"
! grep -q "role=\"group\"" "$tmp_dir/demo/web/src/component/l1/ThemeToggle.jsx"
grep -q "./component/l3/index.js" "$tmp_dir/demo/web/src/main.jsx"
grep -q "AuthView" "$tmp_dir/demo/web/src/main.jsx"
grep -q "DashboardView" "$tmp_dir/demo/web/src/main.jsx"
...
grep -q "export const ui" "$tmp_dir/demo/web/src/component/l1/tokens.js"
grep -q "ThemeToggle" "$tmp_dir/demo/web/src/component/l1/index.js"
! test -f "$tmp_dir/demo/web/src/component/l1/theme.css"
! grep -R "cb-" "$tmp_dir/demo/web/src" >/dev/null
! grep -R -- "--cb-" "$tmp_dir/demo/web/src" >/dev/null
grep -q "ui.action" "$tmp_dir/demo/web/src/component/l1/Button.jsx"
grep -q "ui.input" "$tmp_dir/demo/web/src/component/l1/Field.jsx"
grep -q "buttonClassLayers" "$tmp_dir/demo/web/src/component/l1/Button.jsx"
grep -q "fieldClassLayers" "$tmp_dir/demo/web/src/component/l1/Field.jsx"
grep -q "fieldHintClassLayers" "$tmp_dir/demo/web/src/component/l1/Field.jsx"
grep -q "fieldErrorClassLayers" "$tmp_dir/demo/web/src/component/l1/Field.jsx"
grep -q "inputClassLayers" "$tmp_dir/demo/web/src/component/l1/Field.jsx"
grep -q "panelClassLayers" "$tmp_dir/demo/web/src/component/l1/Surface.jsx"
grep -q "dividerClassLayers" "$tmp_dir/demo/web/src/component/l1/Surface.jsx"
grep -q "badgeClassLayers" "$tmp_dir/demo/web/src/component/l1/Surface.jsx"
grep -q "metricClassLayers" "$tmp_dir/demo/web/src/component/l1/Surface.jsx"
grep -q "eyebrowClassLayers" "$tmp_dir/demo/web/src/component/l1/Text.jsx"
grep -q "headingClassLayers" "$tmp_dir/demo/web/src/component/l1/Text.jsx"
grep -q "mutedClassLayers" "$tmp_dir/demo/web/src/component/l1/Text.jsx"
grep -q "codeClassLayers" "$tmp_dir/demo/web/src/component/l1/Text.jsx"
grep -q "formClassLayers" "$tmp_dir/demo/web/src/component/l2/AuthForm.jsx"
grep -q "formStackClassLayers" "$tmp_dir/demo/web/src/component/l2/AuthForm.jsx"
grep -q "errorClassLayers" "$tmp_dir/demo/web/src/component/l2/AuthForm.jsx"
grep -q "modeButtonClassLayers" "$tmp_dir/demo/web/src/component/l2/AuthForm.jsx"
grep -q "landingClassLayers" "$tmp_dir/demo/web/src/component/l2/Layouts.jsx"
grep -q "dashboardClassLayers" "$tmp_dir/demo/web/src/component/l2/Layouts.jsx"
grep -q "screenClassLayers" "$tmp_dir/demo/web/src/component/l3/DashboardView.jsx"
grep -q "loadingClassLayers" "$tmp_dir/demo/web/src/component/l3/LoadingView.jsx"
grep -q "ui.focus" "$tmp_dir/demo/web/src/component/l1/Field.jsx"
grep -q "ui.focus" "$tmp_dir/demo/web/src/component/l2/AuthForm.jsx"
grep -q "ui.focus" "$tmp_dir/demo/web/src/component/l2/Layouts.jsx"
! grep -R "text-\\[" "$tmp_dir/demo/web/src/component" >/dev/null
grep -q "export function DashboardLayout" "$tmp_dir/demo/web/src/component/l2/Layouts.jsx"
grep -q "lg:grid-cols-\\[216px_minmax(0,1fr)\\]" "$tmp_dir/demo/web/src/component/l2/Layouts.jsx"
grep -q "aria-label=\"Dashboard\"" "$tmp_dir/demo/web/src/component/l2/Layouts.jsx"
grep -q "aria-current" "$tmp_dir/demo/web/src/component/l2/Layouts.jsx"
grep -q "navItems" "$tmp_dir/demo/web/src/component/l2/Layouts.jsx"
grep -q "export function LandingPageLayout" "$tmp_dir/demo/web/src/component/l2/Layouts.jsx"
grep -q "dashboardNav" "$tmp_dir/demo/web/src/component/l3/DashboardView.jsx"
grep -q "WorkspaceOverview" "$tmp_dir/demo/web/src/component/l3/DashboardView.jsx"
...
cd "$tmp_dir/demo"
CARBIDE_HOME="$repo_root" "$repo_root/cli/bin/carbide" doctor env > "$tmp_dir/doctor-env.out"
...
CARBIDE_HOME="$repo_root" "$repo_root/cli/bin/carbide" doctor > "$tmp_dir/doctor.out"
grep -q "Carbide doctor" "$tmp_dir/doctor.out"
grep -q "project contract" "$tmp_dir/doctor.out"
grep -Eq "^project shape[[:space:]]+ok[[:space:]]+web api db agents.d" "$tmp_dir/doctor.out"
grep -Eq "^runtime baseline[[:space:]]+ok[[:space:]]+Go 1.25 React 19.2 Tailwind 4.3 Bun 1.3 Postgres 17" "$tmp_dir/doctor.out"
grep -Eq "^env contract[[:space:]]+ok[[:space:]]+0 missing, 2 secrets" "$tmp_dir/doctor.out"
grep -Eq "^compose[[:space:]]+ok[[:space:]]+web api db" "$tmp_dir/doctor.out"
grep -Eq "^frontend[[:space:]]+ok[[:space:]]+Bun React Tailwind" "$tmp_dir/doctor.out"
grep -Eq "^api[[:space:]]+ok[[:space:]]+Go HTTP API" "$tmp_dir/doctor.out"
grep -Eq "^database[[:space:]]+ok[[:space:]]+Postgres users sessions" "$tmp_dir/doctor.out"
grep -Eq "^agents[[:space:]]+ok[[:space:]]+AGENTS.md agents.d" "$tmp_dir/doctor.out"
grep -Eq "^regressions[[:space:]]+ok[[:space:]]+no legacy markers" "$tmp_dir/doctor.out"
