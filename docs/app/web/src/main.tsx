...
function DocsRuntime() {
  return (
    <main className="min-h-screen bg-amber-50 text-neutral-950 [scrollbar-width:thin] [scrollbar-color:rgb(217_119_6)_transparent] hover:[scrollbar-color:rgb(180_83_9)_transparent] dark:bg-neutral-950 dark:text-neutral-50 dark:[scrollbar-color:rgb(250_204_21)_transparent] dark:hover:[scrollbar-color:rgb(253_224_71)_transparent]">
      <section className="mx-auto grid min-h-screen max-w-3xl place-items-center px-4 py-10 text-center">
        <div className="grid gap-3">
          ...
          <p className="text-sm/6 text-neutral-700 dark:text-neutral-300">
