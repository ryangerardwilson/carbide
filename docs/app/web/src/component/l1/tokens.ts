...
export const ui = {
  accent: "text-amber-950 dark:text-amber-100",
  ...
  hero: "bg-amber-50 text-neutral-950 dark:bg-neutral-950 dark:text-amber-50",
  heroMuted: "text-amber-900/80 dark:text-amber-200/72",
  muted: "text-amber-950/72 dark:text-amber-200/68",
  page: `bg-amber-50 text-neutral-950 font-sans dark:bg-neutral-950 dark:text-amber-50 ${scrollbar}`,
  scrollbar,
  shadowSubtle: "shadow-sm shadow-amber-950/10 dark:shadow-black/70",
  subtle: "text-amber-900/55 dark:text-amber-200/52",
  ...
  text: "text-neutral-950 dark:text-amber-50",
};
...
export const docsClassLayers = {
  ...
  link: {
    ...
    l3: "text-amber-950/78 hover:text-amber-950 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-amber-700 dark:text-amber-200/78 dark:hover:text-yellow-300 dark:focus-visible:outline-yellow-300",
  },
  surface: {
