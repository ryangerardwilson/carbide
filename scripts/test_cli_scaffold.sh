...
test -f "$tmp_dir/demo/views/layout.html"
test -f "$tmp_dir/demo/views/home.html"
test -f "$tmp_dir/demo/views/login.html"
test -f "$tmp_dir/demo/views/register.html"
test -f "$tmp_dir/demo/views/dashboard.html"
test -f "$tmp_dir/demo/views/not_found.html"
...
grep -q "path: ./views" "$tmp_dir/demo/docker-compose.yml"
...
grep -q "{{ title }}" "$tmp_dir/demo/views/layout.html"
grep -q "{!! content !!}" "$tmp_dir/demo/views/layout.html"
grep -q "{{ user_email }}" "$tmp_dir/demo/views/dashboard.html"
