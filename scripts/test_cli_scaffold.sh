...
test -d "$tmp_dir/demo/view/web/src/component/l1"
test -d "$tmp_dir/demo/view/web/src/component/l2"
test -d "$tmp_dir/demo/view/web/src/component/l3"
test -f "$tmp_dir/demo/view/web/src/component/utils.js"
test -f "$tmp_dir/demo/view/web/src/component/l1/Button.jsx"
test -f "$tmp_dir/demo/view/web/src/component/l1/Field.jsx"
test -f "$tmp_dir/demo/view/web/src/component/l1/Surface.jsx"
test -f "$tmp_dir/demo/view/web/src/component/l1/Text.jsx"
test -f "$tmp_dir/demo/view/web/src/component/l1/theme.css"
test -f "$tmp_dir/demo/view/web/src/component/l1/tokens.js"
test -f "$tmp_dir/demo/view/web/src/component/l2/Accordion.jsx"
test -f "$tmp_dir/demo/view/web/src/component/l2/AuthForm.jsx"
test -f "$tmp_dir/demo/view/web/src/component/l2/Carousel.jsx"
test -f "$tmp_dir/demo/view/web/src/component/l2/CarouselIntegrations.jsx"
test -f "$tmp_dir/demo/view/web/src/component/l2/Charts.jsx"
test -f "$tmp_dir/demo/view/web/src/component/l2/Combobox.jsx"
test -f "$tmp_dir/demo/view/web/src/component/l2/DateComponents.jsx"
test -f "$tmp_dir/demo/view/web/src/component/l2/Dropdown.jsx"
test -f "$tmp_dir/demo/view/web/src/component/l2/EnhancedSelects.jsx"
test -f "$tmp_dir/demo/view/web/src/component/l2/Layouts.jsx"
test -f "$tmp_dir/demo/view/web/src/component/l2/Lessons.jsx"
test -f "$tmp_dir/demo/view/web/src/component/l2/Listbox.jsx"
test -f "$tmp_dir/demo/view/web/src/component/l2/Modal.jsx"
test -f "$tmp_dir/demo/view/web/src/component/l2/Notifications.jsx"
test -f "$tmp_dir/demo/view/web/src/component/l2/Popover.jsx"
test -f "$tmp_dir/demo/view/web/src/component/l2/RadioGroup.jsx"
test -f "$tmp_dir/demo/view/web/src/component/l2/Tabs.jsx"
test -f "$tmp_dir/demo/view/web/src/component/l2/TextEditors.jsx"
test -f "$tmp_dir/demo/view/web/src/component/l2/Toggle.jsx"
test -f "$tmp_dir/demo/view/web/src/component/l2/Tooltip.jsx"
test -f "$tmp_dir/demo/view/web/src/component/l3/AuthView.jsx"
test -f "$tmp_dir/demo/view/web/src/component/l3/ComponentLibraryView.jsx"
test -f "$tmp_dir/demo/view/web/src/component/l3/DashboardView.jsx"
test -f "$tmp_dir/demo/view/web/src/component/l3/LoadingView.jsx"
...
grep -q '@import "./component/l1/theme.css";' "$tmp_dir/demo/view/web/src/styles.css"
grep -q '/api/${mode}' "$tmp_dir/demo/view/web/src/main.jsx"
grep -q "./component/l3/index.js" "$tmp_dir/demo/view/web/src/main.jsx"
grep -q "AuthView" "$tmp_dir/demo/view/web/src/main.jsx"
grep -q "DashboardView" "$tmp_dir/demo/view/web/src/main.jsx"
grep -R -q "Bun + Go + Postgres" "$tmp_dir/demo/view/web/src/component"
grep -R -q "React + Bun container" "$tmp_dir/demo/view/web/src/component"
grep -q "export const color" "$tmp_dir/demo/view/web/src/component/l1/tokens.js"
grep -q "export const ui" "$tmp_dir/demo/view/web/src/component/l1/tokens.js"
grep -q -- "--cb-font-sans" "$tmp_dir/demo/view/web/src/component/l1/theme.css"
grep -q -- "--cb-color-action" "$tmp_dir/demo/view/web/src/component/l1/theme.css"
grep -q "ui.action" "$tmp_dir/demo/view/web/src/component/l1/Button.jsx"
grep -q "ui.input" "$tmp_dir/demo/view/web/src/component/l1/Field.jsx"
grep -q "export function Dropdown" "$tmp_dir/demo/view/web/src/component/l2/Dropdown.jsx"
grep -q "export const Menu = Dropdown" "$tmp_dir/demo/view/web/src/component/l2/Dropdown.jsx"
grep -q "export function Modal" "$tmp_dir/demo/view/web/src/component/l2/Modal.jsx"
grep -q "export const Dialog = Modal" "$tmp_dir/demo/view/web/src/component/l2/Modal.jsx"
grep -q "export function Slideover" "$tmp_dir/demo/view/web/src/component/l2/Modal.jsx"
grep -q "export function Accordion" "$tmp_dir/demo/view/web/src/component/l2/Accordion.jsx"
grep -q "export const Disclosure = Accordion" "$tmp_dir/demo/view/web/src/component/l2/Accordion.jsx"
grep -q "export function Carousel" "$tmp_dir/demo/view/web/src/component/l2/Carousel.jsx"
grep -q "export function Tabs" "$tmp_dir/demo/view/web/src/component/l2/Tabs.jsx"
grep -q "export function Notifications" "$tmp_dir/demo/view/web/src/component/l2/Notifications.jsx"
grep -q "export function RadioGroup" "$tmp_dir/demo/view/web/src/component/l2/RadioGroup.jsx"
grep -q "export function Radio" "$tmp_dir/demo/view/web/src/component/l2/RadioGroup.jsx"
grep -q "export function Toggle" "$tmp_dir/demo/view/web/src/component/l2/Toggle.jsx"
grep -q "export const Switch = Toggle" "$tmp_dir/demo/view/web/src/component/l2/Toggle.jsx"
grep -q "export function Tooltip" "$tmp_dir/demo/view/web/src/component/l2/Tooltip.jsx"
grep -q "export function Popover" "$tmp_dir/demo/view/web/src/component/l2/Popover.jsx"
grep -q "export function Listbox" "$tmp_dir/demo/view/web/src/component/l2/Listbox.jsx"
grep -q "export function Combobox" "$tmp_dir/demo/view/web/src/component/l2/Combobox.jsx"
grep -q "export function Lessons" "$tmp_dir/demo/view/web/src/component/l2/Lessons.jsx"
grep -q "export function DashboardLayout" "$tmp_dir/demo/view/web/src/component/l2/Layouts.jsx"
grep -q "lg:grid-cols-\\[280px_minmax(0,1fr)\\]" "$tmp_dir/demo/view/web/src/component/l2/Layouts.jsx"
grep -q "aria-label=\"Dashboard\"" "$tmp_dir/demo/view/web/src/component/l2/Layouts.jsx"
grep -q "aria-current" "$tmp_dir/demo/view/web/src/component/l2/Layouts.jsx"
grep -q "navItems" "$tmp_dir/demo/view/web/src/component/l2/Layouts.jsx"
grep -q "export function LandingPageLayout" "$tmp_dir/demo/view/web/src/component/l2/Layouts.jsx"
grep -q "export function TrixEditor" "$tmp_dir/demo/view/web/src/component/l2/TextEditors.jsx"
grep -q "export function QuillEditor" "$tmp_dir/demo/view/web/src/component/l2/TextEditors.jsx"
grep -q "export function SimpleMDEEditor" "$tmp_dir/demo/view/web/src/component/l2/TextEditors.jsx"
grep -q "export function ChartJsPanel" "$tmp_dir/demo/view/web/src/component/l2/Charts.jsx"
grep -q "export function ApexChartsPanel" "$tmp_dir/demo/view/web/src/component/l2/Charts.jsx"
grep -q "export function Select2Select" "$tmp_dir/demo/view/web/src/component/l2/EnhancedSelects.jsx"
grep -q "export function ChoicesSelect" "$tmp_dir/demo/view/web/src/component/l2/EnhancedSelects.jsx"
grep -q "export function FlatpickrPicker" "$tmp_dir/demo/view/web/src/component/l2/DateComponents.jsx"
grep -q "export function DateRangePicker" "$tmp_dir/demo/view/web/src/component/l2/DateComponents.jsx"
grep -q "export function FullCalendarPanel" "$tmp_dir/demo/view/web/src/component/l2/DateComponents.jsx"
grep -q "export function GlideCarousel" "$tmp_dir/demo/view/web/src/component/l2/CarouselIntegrations.jsx"
grep -q "export function SplideCarousel" "$tmp_dir/demo/view/web/src/component/l2/CarouselIntegrations.jsx"
grep -q "dashboardNav" "$tmp_dir/demo/view/web/src/component/l3/DashboardView.jsx"
grep -q "WorkspaceOverview" "$tmp_dir/demo/view/web/src/component/l3/DashboardView.jsx"
grep -q "onNavItem={setActiveSection}" "$tmp_dir/demo/view/web/src/component/l3/DashboardView.jsx"
