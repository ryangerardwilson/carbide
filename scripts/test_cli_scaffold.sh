...
grep -Fq '<s-l2.layout :passover=[title,app_name]>' "$tmp_dir/demo/view/home.skin"
grep -Fq '</s-l2.layout>' "$tmp_dir/demo/view/home.skin"
grep -Fq '<s-l3.home-page :passover=[app_name] />' "$tmp_dir/demo/view/home.skin"
grep -Fq '<s-l2.auth-form :passover=[auth_title,auth_action,email_value,password_autocomplete,submit_label,error,auth_footer] />' "$tmp_dir/demo/view/login.skin"
grep -Fq '<s-l2.auth-form :passover=[auth_title,auth_action,email_value,password_autocomplete,submit_label,error,auth_footer] />' "$tmp_dir/demo/view/register.skin"
